...
day8:
	...
	verilator --cc _build/day08.v --exe day8/test/main.cpp --top-module day08 -O3 -Wno-DEPRECATED -Wno-fatal -Wno-WIDTH -Wno-COMBDLY --Mdir _build/obj_dir
...
day8_synth:
	yosys -p "synth_ecp5 -top day08; stat" _build/day08.v
